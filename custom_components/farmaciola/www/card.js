...
.title { font-size: 1.225rem; font-weight: 700; flex-shrink: 0; }
.search {
  flex: 1; min-width: 140px;
  background: var(--input-fill-color, var(--secondary-background-color));
  border: 1.5px solid var(--divider-color); border-radius: 999px;
  padding: 7px 14px; font-size: 1rem; color: var(--primary-text-color); outline: none;
}
...
.btn-secondary {
  ...
  border: 1.5px solid var(--divider-color); border-radius: 999px;
  padding: 7px 14px; font-size: 1rem; font-weight: 600; cursor: pointer;
}
.btn-danger {
  background: var(--error-color, #c62828); color: white; border: none;
  border-radius: 999px; padding: 7px 14px; font-size: 1rem; font-weight: 600; cursor: pointer;
}
.med-row {
  display: flex; align-items: center; gap: 12px;
